...
Built-in services will be available soon and, also, you are able to create your own service types as long as they respect the service contract.
The service contract will be defined in the [docs](/docs) (TODO)
